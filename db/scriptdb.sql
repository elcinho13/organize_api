...
CREATE TABLE IF NOT EXISTS `org_user`(
    ...
    KEY `org_user_fk2` (`term`),
    CONSTRAINT `org_user_fk2` FOREIGN KEY (`term`) REFERENCES `org_term` (`id`)
)ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `org_token`(
    ...
    KEY `org_token_fk3` (`login_type`),
    CONSTRAINT `org_token_fk3` FOREIGN KEY (`login_type`) REFERENCES `org_login_type` (`id`)
